...
app.config["MAIL_PASSWORD"] = "cxvy suqg jxbw iilp"
...
def edit_student(Contact):
    if request.method == "GET":
        ...
        cur.close()
        return render_template("class.html", mylist=info_results)
    else:
        img = request.files["my_image"]
        problem = request.form.get("problem")
        if not img:
            return "Image not found"
        img.filename = str("Hai")
        ...
        cur.close()
        universal = {
            0: "shubhanshum154@gmail.com",
            1: "shubhanshum154@gmail.com",
            2: "shubhanshum154@gmail.com",
        }
        ...
        # cur.close()
        new1 = email
        if preds in universal:
            new = universal[preds]
        else:
            new = "shubhanshum154@gmail.com"
        ...
        mail.send(msg)
        return render_template("/last_one.html")
...
def contact():
    if request.method == "GET":
        ...
        msg = Message(messages, sender=email, recipients=["shubhanshum154@gmail.com"])
        msg.body = messages
